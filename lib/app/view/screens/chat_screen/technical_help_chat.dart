...
class TechnicalHelpChat extends StatefulWidget {
  const TechnicalHelpChat({super.key});

  @override
  State<TechnicalHelpChat> createState() => _TechnicalHelpChatState();
}

class _TechnicalHelpChatState extends State<TechnicalHelpChat> {
      ...
      body: Stack(
        children: [
          ListView.builder(
            ...
            padding: const EdgeInsets.only(top: 10, bottom: 89),
