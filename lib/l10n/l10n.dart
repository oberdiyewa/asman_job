...
extension AppLocalizationsX on BuildContext {
  AppLocalizationsJob? get l10n => AppLocalizationsJob.of(this);
}
...
extension L10n on String {
  String get trs {
    var result = AppLocalizationsJob(null).translate(this);
    ...
    result ??= AppLocalizationsJob.templocalizedStrings[this];

    return result ?? this;
  }
}

class AppLocalizationsJob {
  factory AppLocalizationsJob(Locale? locale) {
    if (locale != null && locale != _instance.locale) {
      ...
      return AppLocalizationsJob._(locale);
    }
    return _instance;
  }
  AppLocalizationsJob._(this.locale);
  static AppLocalizationsJob _instance = AppLocalizationsJob._(const Locale('ru'));
  final Locale locale;
  ...
  static AppLocalizationsJob? of(BuildContext context) {
    return Localizations.of<AppLocalizationsJob>(context, AppLocalizationsJob);
  }

  static const LocalizationsDelegate<AppLocalizationsJob> delegate =
  ...
  Future<bool> load() async {
    final jsonString = await rootBundle
        .loadString('${Assets.languagePath}/${locale.languageCode}.json');
...
class _AppLocalizationsDelegate
    extends LocalizationsDelegate<AppLocalizationsJob> {
  const _AppLocalizationsDelegate();

  @override
  bool isSupported(Locale locale) {
    return ['en', 'ru', 'tm'].contains(locale.languageCode);
  }

  @override
  Future<AppLocalizationsJob> load(Locale locale) async {
    final localizations = AppLocalizationsJob(const Locale('ru'));
    await localizations.load();
    return localizations;
  }

  @override
  bool shouldReload(covariant LocalizationsDelegate<AppLocalizationsJob> old) {
    return false;
  }
}
